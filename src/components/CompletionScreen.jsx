...
export function CompletionScreen({topic,revisitCards,confusedCards,starredCards,onHome,onRevisitAll,onStudyFlagged,onStudyStarred}){
  return(
    <div style={{padding:"40px 0 24px",textAlign:"center"}}>
      <div style={{width:80,height:80,borderRadius:"50%",background:`${S.green}22`,border:`2px solid ${S.green}`,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 24px"}}>
        <Trophy size={36} color={S.green}/>
      </div>
